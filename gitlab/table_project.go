...
func projectColumns() []*plugin.Column {
	return []*plugin.Column{
		...
		},
		{
			...
			Transform:   transform.FromField("Statistics.StorageStatistics.RepositorySize"),
		},
		{
			Name:        "lfs_objects_size",
			Type:        proto.ColumnType_INT,
			Description: "The size of the projects LFS objects on disk.",
			Transform:   transform.FromField("Statistics.StorageStatistics.LfsObjectsSize"),
		},
		{
			Name:        "job_artifacts_size",
			Type:        proto.ColumnType_INT,
			Description: "The size of projects job artifacts on disk.",
			Transform:   transform.FromField("Statistics.StorageStatistics.JobArtifactsSize"),
		},
		{
